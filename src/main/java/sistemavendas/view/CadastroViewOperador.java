 ...
 */
public class CadastroViewOperador extends JFrame {
	/**
	 * Root.
	 */
	private JPanel root;
	 ...
	 * @param s s
	 */
	public CadastroViewOperador( String s ) {
		super( s );
	...
	private void criarComponentes() {
		...
		/* Criar label título */
		JLabel titulo = new JLabel( "Cadastrar Operador" );
			...
			if ( senha.equals( senha2 ) ) {
				if ( Operador.cadastrarUsuario( login, senha ) ) {
					...
					JOptionPane.showMessageDialog( null,
					                               "Não foi possível cadastrar o operador, usuário já existe!"
					);
				}
			} else {
